...
" Remap Y to be usual y but shortcut to system clipboard
vnoremap Y "+y
" Map Meta-P to system clipboard paste
vnoremap <M-p> "+p
nnoremap <M-p> "+P
...
" Allows you to visv:register	ually select a section and then hit @ to run a macro on all lines
